...
if sys.version_info >= (3, 11):
    ...
    try:
        from lib.vendor.tomli import TOMLDecodeError
        from lib.vendor.tomli import loads as toml_loads
    except ModuleNotFoundError:  # pragma: no cover
        from lib.vendor.toml import TomlDecodeError as TOMLDecodeError  # type: ignore[import,no-redef]
        from lib.vendor.toml import loads as toml_loads  # type: ignore[no-redef]
...
def check_dependency(
    ...
    """
    import lib.vendor.packaging.requirements
    ...
    req = lib.vendor.packaging.requirements.Requirement(req_string)
