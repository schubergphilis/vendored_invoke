...
if sys.version_info < (3, 9):
    from lib.vendor.typing_extensions import Literal, Match, TypedDict  # type: ignore
else:
    from typing import Literal, Match, TypedDict

from lib.vendor.emoji import unicode_codes
from lib.vendor.emoji.tokenizer import (
    Token,
    EmojiMatch,
    EmojiMatchZWJ,
    EmojiMatchZWJNonRGI,
