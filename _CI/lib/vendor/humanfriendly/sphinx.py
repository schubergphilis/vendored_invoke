...
from lib.vendor.humanfriendly.deprecation import get_aliases
from lib.vendor.humanfriendly.text import compact, dedent, format
from lib.vendor.humanfriendly.usage import USAGE_MARKER, render_usage
...
def setup(app):
    ...
    """
    from lib.vendor.humanfriendly import __version__
