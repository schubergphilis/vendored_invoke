...
from lib.vendor.humanfriendly.compat import HTMLParser, StringIO, name2codepoint, unichr
from lib.vendor.humanfriendly.text import compact_empty_lines
from lib.vendor.humanfriendly.terminal import ANSI_COLOR_CODES, ANSI_RESET, ansi_style
...
class HTMLConverter(HTMLParser):
    ...
    .. code-block:: python
       ...
       from lib.vendor.humanfriendly.text import dedent
       from lib.vendor.humanfriendly.terminal import html_to_ansi
