...
from lib.vendor.humanfriendly import (
    InvalidDate,
    InvalidLength,
    InvalidSize,
    InvalidTimespan,
...
from lib.vendor.humanfriendly.case import CaseInsensitiveDict, CaseInsensitiveKey
from lib.vendor.humanfriendly.cli import main
from lib.vendor.humanfriendly.compat import StringIO
from lib.vendor.humanfriendly.decorators import cached
from lib.vendor.humanfriendly.deprecation import DeprecationProxy, define_aliases, deprecated_args, get_aliases
from lib.vendor.humanfriendly.prompts import (
    TooManyInvalidReplies,
    prompt_for_confirmation,
    prompt_for_choice,
    prompt_for_input,
)
from lib.vendor.humanfriendly.sphinx import (
...
from lib.vendor.humanfriendly.tables import (
    format_pretty_table,
    format_robust_table,
    format_rst_table,
    format_smart_table,
)
from lib.vendor.humanfriendly.terminal import (
    ANSI_CSI,
    ANSI_ERASE_LINE,
    ANSI_HIDE_CURSOR,
    ANSI_RESET,
...
from lib.vendor.humanfriendly.terminal.html import html_to_ansi
from lib.vendor.humanfriendly.terminal.spinners import AutomaticSpinner, Spinner
from lib.vendor.humanfriendly.testing import (
    CallableTimedOut,
    CaptureOutput,
    MockedProgram,
    PatchedAttribute,
...
from lib.vendor.humanfriendly.text import (
    compact,
    compact_empty_lines,
    concatenate,
    dedent,
...
from lib.vendor.humanfriendly.usage import (
    find_meta_variables,
    format_usage,
    parse_usage,
    render_usage,
...
class HumanFriendlyTestCase(TestCase):
    ...
    def test_split(self):
        ...
        from lib.vendor.humanfriendly.text import split
    ...
    def test_sphinx_customizations(self):
        ...
        from lib.vendor.humanfriendly import cli, sphinx
