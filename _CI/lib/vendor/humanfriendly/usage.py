...
from lib.vendor.humanfriendly.text import dedent, split_paragraphs, trim_empty_lines
...
def format_usage(usage_text):
    ...
    from lib.vendor.humanfriendly.terminal import ansi_wrap, HIGHLIGHT_COLOR
    formatted_lines = []
