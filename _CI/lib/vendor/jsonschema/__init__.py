...
from lib.vendor.jsonschema._format import FormatChecker
from lib.vendor.jsonschema._types import TypeChecker
from lib.vendor.jsonschema.exceptions import SchemaError, ValidationError
from lib.vendor.jsonschema.validators import (
    Draft3Validator,
    Draft4Validator,
    Draft6Validator,
    Draft7Validator,
...
def __getattr__(name):
    if name == "__version__":
        ...
        from lib.vendor.jsonschema.validators import _RefResolver
        warnings.warn(
        ...
        from lib.vendor.jsonschema.exceptions import ErrorTree
        return ErrorTree
        ...
        from lib.vendor.jsonschema.exceptions import FormatError
        return FormatError
    elif name == "Validator":
        warnings.warn(
        ...
        from lib.vendor.jsonschema.protocols import Validator
        return Validator
    elif name == "RefResolutionError":
        from lib.vendor.jsonschema.exceptions import _RefResolutionError
        warnings.warn(
