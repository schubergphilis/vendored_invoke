...
from lib.vendor.attrs import define
from lib.vendor.referencing.exceptions import Unresolvable as _Unresolvable

from lib.vendor.jsonschema import _utils

if TYPE_CHECKING:
    from collections.abc import Iterable, Mapping, MutableMapping, Sequence

    from lib.vendor.jsonschema import _types
