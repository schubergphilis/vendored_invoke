...
from lib.vendor.pygments.lexer import Lexer, RegexLexer, include, bygroups, using, \
    default, words, combined, do_insertions, this, line_re
from lib.vendor.pygments.util import get_bool_opt, shebang_matches
from lib.vendor.pygments.token import Text, Comment, Operator, Keyword, Name, String, \
    Number, Punctuation, Generic, Other, Error, Whitespace
from lib.vendor.pygments import unistring as uni
