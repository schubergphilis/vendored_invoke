...
from lib.vendor.rich._null_file import NULL_FILE

if sys.version_info >= (3, 8):
    from typing import Literal, Protocol, runtime_checkable
else:
    from lib.vendor.typing_extensions import (
        Literal,
        Protocol,
        runtime_checkable,
    )  # pragma: no cover
...
class Console:
    ...
    def print_json(
        ...
        *,
        ...
        """
        from lib.vendor.rich.json import JSON
                ...
                if self.is_jupyter:  # pragma: no cover
                    ...
                    if WINDOWS:
                        ...
                        if use_legacy_windows_render:
                            from lib.vendor.rich._win32_console import LegacyWindowsTerm
                            from lib.vendor.rich._windows_renderer import legacy_windows_render
    ...
    def export_svg(
        ...
        *,
        ...
        from lib.vendor.rich.cells import cell_len
