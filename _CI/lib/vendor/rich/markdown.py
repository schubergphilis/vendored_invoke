...
from lib.vendor.markdown_it import MarkdownIt
from lib.vendor.markdown_it.token import Token

if sys.version_info >= (3, 8):
    from typing import get_args
else:
    from lib.vendor.typing_extensions import get_args  # pragma: no cover
