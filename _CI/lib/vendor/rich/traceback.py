...
from lib.vendor.pygments.lexers import guess_lexer_for_filename
from lib.vendor.pygments.token import Comment, Keyword, Name, Number, Operator, String
from lib.vendor.pygments.token import Text as TextToken
from lib.vendor.pygments.token import Token
...
class Traceback:
    ...
    def extract(
        ...
        *,
        ...
        from lib.vendor.rich import _IMPORT_CWD
