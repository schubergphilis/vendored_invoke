...
from lib.vendor.jsonschema import ValidationError, validate
from lib.vendor.toml import TomlDecodeError
from lib.vendor.toml import loads as parse_toml

from lib.vendor.vendoring.errors import ConfigurationError
