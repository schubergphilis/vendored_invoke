...
from libs.vendor.jsonschema._format import FormatChecker
from libs.vendor.jsonschema._types import TypeChecker
from libs.vendor.jsonschema.exceptions import SchemaError, ValidationError
from libs.vendor.jsonschema.protocols import Validator
from libs.vendor.jsonschema.validators import (
    Draft3Validator,
    Draft4Validator,
    Draft6Validator,
    Draft7Validator,
...
def __getattr__(name):
    if name == "__version__":
        ...
        from libs.vendor.jsonschema.validators import _RefResolver
        warnings.warn(
        ...
        from libs.vendor.jsonschema.exceptions import FormatError
        return FormatError
    elif name == "RefResolutionError":
        from libs.vendor.jsonschema.exceptions import _RefResolutionError
        warnings.warn(
