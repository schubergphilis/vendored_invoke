...
if TYPE_CHECKING:
    from libs.vendor.jsonschema import _typing
    from libs.vendor import jsonschema
    import libs.vendor.jsonschema.validators
    from libs.vendor.referencing import jsonschema

from libs.vendor.jsonschema.exceptions import ValidationError
...
class Validator(Protocol):
    ...
    def __init__(
        self,
        schema: Mapping | bool,
        registry: referencing_jsonschema.SchemaRegistry,
