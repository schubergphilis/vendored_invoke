...
from libs.vendor.attrs import evolve, field
from libs.vendor.rpds import HashTrieMap, HashTrieSet, List

from libs.vendor.referencing import exceptions
from libs.vendor.referencing._attrs import frozen
from libs.vendor.referencing.typing import URI, Anchor as AnchorType, D, Mapping, Retrieve
    ...
    def from_contents(
        ...
        if isinstance(contents, Mapping):
            ...
            if jsonschema_dialect_id is not None:
                from referencing_jsonschema.import specification_with
