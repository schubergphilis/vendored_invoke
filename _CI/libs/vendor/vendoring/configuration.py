...
from libs.vendor.jsonschema import ValidationError, validate
from libs.vendor.toml import TomlDecodeError
from libs.vendor.toml import loads as parse_toml

from libs.vendor.vendoring.errors import ConfigurationError
