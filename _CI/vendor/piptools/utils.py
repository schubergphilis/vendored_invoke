...
from _CI.vendor.click.utils import LazyFile
...
from _CI.vendor.piptools._compat import PIP_VERSION
from _CI.vendor.piptools.subprocess_utils import run_python_snippet
...
def get_compile_command(click_ctx: click.Context) -> str:
    ...
    """
    from _CI.vendor.piptools.scripts.compile import cli
