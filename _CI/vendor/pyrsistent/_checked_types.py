...
from _CI.vendor.pyrsistent._pmap import PMap, pmap
from _CI.vendor.pyrsistent._pset import PSet, pset
from _CI.vendor.pyrsistent._pvector import PythonPVector, python_pvector
