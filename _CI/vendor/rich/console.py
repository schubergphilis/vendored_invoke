...
from _CI.vendor.rich._null_file import NULL_FILE
...
class Console:
    ...
    def print_json(
        ...
        *,
        ...
        """
        from _CI.vendor.rich.json import JSON
                ...
                if self.is_jupyter:  # pragma: no cover
                    ...
                    if WINDOWS:
                        ...
                        if use_legacy_windows_render:
                            from _CI.vendor.rich._win32_console import LegacyWindowsTerm
                            from _CI.vendor.rich._windows_renderer import legacy_windows_render
    ...
    def export_svg(
        ...
        *,
        ...
        from _CI.vendor.rich.cells import cell_len
