...
from _CI.vendor.jsonschema import ValidationError, validate
from _CI.vendor.toml import TomlDecodeError
from _CI.vendor.toml import loads as parse_toml

from _CI.vendor.vendoring.errors import ConfigurationError
