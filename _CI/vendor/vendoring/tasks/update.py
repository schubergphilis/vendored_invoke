...
from _CI.vendor import requests
from _CI.vendor.packaging.version import VERSION_PATTERN, Version

from _CI.vendor.vendoring.configuration import Configuration
from _CI.vendor.vendoring.errors import RequirementsError, VendoringError
